...
function Maplocate() {
  return (
    <div className='flex flex-col mx-4 md:mx-[10rem] mb-12' >
      {/* left */}
      <div className="w-full flex items-center mr-2">
        <div className="">
        <h1 className='text-2xl my-4 font-poppins font-bold text-center capitalize '>locate us at :</h1>
        </div>
      </div>
      {/* right */}
      <div className=" w-full">
        <div className=" ">
           <p className='overflow-hidden  relative shadow-lg  rounded-xl'>
            ...
            title='Responsive Google Map ' className='w-full h-[15rem]'>
